...
export function About() {
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 md:px-6 py-12 rounded-2xl lg:pl-24">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col justify-center space-y-6 animate-in fade-in slide-in-from-right-12 duration-1000">
            ...
            <div className="flex items-center gap-4">
              ...
              <Button
                variant="ghost"
                className="rounded-full text-foreground transition-all duration-300 ease-in-out hover:text-primary hover:bg-primary/10 hover:shadow-md hover:scale-105"
                onClick={donwnloadCV}
              >
                Download CV
              </Button>
